 ...
 * @author Azka
 */
public class LoginFormtoMenu extends javax.swing.JFrame {
    private Connection conn = new Inv_Connect().connect();
    /**
     * Creates new form LoginForm
     */
    public LoginFormtoMenu() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginFormtoMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginFormtoMenu().setVisible(true);
            }
        });
    }
